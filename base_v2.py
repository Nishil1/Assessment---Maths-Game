...
# List for yes_no responses and easy medium and hard
valid_inputs = ["yes", "no", "easy", "medium", "hard"]

# Asks user if they have played the game before
show_instructions = choice_checker("Have you played the game before? ", valid_inputs[:-3], "Please enter yes/no")
...
which_mode = choice_checker("Choose mode: ", valid_inputs[2:], "Please choose easy, medium or hard")
print()
